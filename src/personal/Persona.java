 ...
 * @author Francesca
 */
public abstract class Persona implements principal.Element {
    ...
    public void elementXml() {
        nu.xom.Element nifxml = new nu.xom.Element("nif");
        nu.xom.Element nomxml = new nu.xom.Element("nom");
        nu.xom.Element cognomxml = new nu.xom.Element("cognom");
    }
